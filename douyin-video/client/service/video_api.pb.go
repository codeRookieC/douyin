...
func (x *DouyinFeedRequest) Reset() {
	*x = DouyinFeedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_api_proto_msgTypes[0]
...
func (*DouyinFeedRequest) Descriptor() ([]byte, []int) {
	return file_video_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinFeedResponse) Reset() {
	*x = DouyinFeedResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_api_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFeedResponse) Descriptor() ([]byte, []int) {
	return file_video_api_proto_rawDescGZIP(), []int{1}
}
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_api_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_video_api_proto_rawDescGZIP(), []int{2}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_api_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_video_api_proto_rawDescGZIP(), []int{3}
}
...
func (x *DouyinPublishActionRequest) Reset() {
	*x = DouyinPublishActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_api_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishActionRequest) Descriptor() ([]byte, []int) {
	return file_video_api_proto_rawDescGZIP(), []int{4}
}
...
func (x *DouyinPublishActionResponse) Reset() {
	*x = DouyinPublishActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_api_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishActionResponse) Descriptor() ([]byte, []int) {
	return file_video_api_proto_rawDescGZIP(), []int{5}
}
...
func (x *DouyinPublishListRequest) Reset() {
	*x = DouyinPublishListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_api_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishListRequest) Descriptor() ([]byte, []int) {
	return file_video_api_proto_rawDescGZIP(), []int{6}
}
...
func (x *DouyinPublishListResponse) Reset() {
	*x = DouyinPublishListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_api_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishListResponse) Descriptor() ([]byte, []int) {
	return file_video_api_proto_rawDescGZIP(), []int{7}
}
...
var File_video_api_proto protoreflect.FileDescriptor

var file_video_api_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x0c, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22,
	...
	0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x12, 0x32, 0x0a, 0x0a, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x76, 0x69, 0x64,
	0x65, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52,
	...
	0x65, 0x78, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xfe, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65,
	0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x02, 0x28, 0x03, 0x52, 0x02, 0x69,
	0x64, 0x12, 0x2a, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x02, 0x28,
	0x0b, 0x32, 0x12, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x22, 0x5f, 0x0a, 0x1d,
	...
	0x6b, 0x65, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x02, 0x28,
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65,
	0x18, 0x03, 0x20, 0x02, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x60, 0x0a,
	...
	,
	...
	,
}

var (
	file_video_api_proto_rawDescOnce sync.Once
	file_video_api_proto_rawDescData = file_video_api_proto_rawDesc
)

func file_video_api_proto_rawDescGZIP() []byte {
	file_video_api_proto_rawDescOnce.Do(func() {
		file_video_api_proto_rawDescData = protoimpl.X.CompressGZIP(file_video_api_proto_rawDescData)
	})
	return file_video_api_proto_rawDescData
}

var file_video_api_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_video_api_proto_goTypes = []interface{}{
	(*DouyinFeedRequest)(nil),           // 0: videoService.douyin_feed_request
	(*DouyinFeedResponse)(nil),          // 1: videoService.douyin_feed_response
	(*Video)(nil),                       // 2: videoService.Video
	(*User)(nil),                        // 3: videoService.User
	(*DouyinPublishActionRequest)(nil),  // 4: videoService.douyin_publish_action_request
	(*DouyinPublishActionResponse)(nil), // 5: videoService.douyin_publish_action_response
	(*DouyinPublishListRequest)(nil),    // 6: videoService.douyin_publish_list_request
	(*DouyinPublishListResponse)(nil),   // 7: videoService.douyin_publish_list_response
}
var file_video_api_proto_depIdxs = []int32{
	2, // 0: videoService.douyin_feed_response.video_list:type_name -> videoService.Video
	3, // 1: videoService.Video.author:type_name -> videoService.User
	2, // 2: videoService.douyin_publish_list_response.video_list:type_name -> videoService.Video
	0, // 3: videoService.VideoService.douyinFeed:input_type -> videoService.douyin_feed_request
	4, // 4: videoService.VideoService.DouyinPublishAction:input_type -> videoService.douyin_publish_action_request
	6, // 5: videoService.VideoService.DouyinPublishList:input_type -> videoService.douyin_publish_list_request
	1, // 6: videoService.VideoService.douyinFeed:output_type -> videoService.douyin_feed_response
	5, // 7: videoService.VideoService.DouyinPublishAction:output_type -> videoService.douyin_publish_action_response
	7, // 8: videoService.VideoService.DouyinPublishList:output_type -> videoService.douyin_publish_list_response
...
func init() { file_video_api_proto_init() }
func file_video_api_proto_init() {
	if File_video_api_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_video_api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_video_api_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_video_api_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_video_api_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_video_api_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_video_api_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_video_api_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_video_api_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_video_api_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_video_api_proto_goTypes,
		DependencyIndexes: file_video_api_proto_depIdxs,
		MessageInfos:      file_video_api_proto_msgTypes,
	}.Build()
	File_video_api_proto = out.File
	file_video_api_proto_rawDesc = nil
	file_video_api_proto_goTypes = nil
	file_video_api_proto_depIdxs = nil
}
