...
func main() {
	...
	//User := g.GenerateModel("userServer")
	...
	// append(
	//    fieldOpts,
	//    // userServer 一对多 address 关联, 外键`uid`在 address 表中
	//    gen.FieldRelate(field.HasMany, "userServer", User, &field.RelateConfig{GORMTag: "foreignKey:UID"}),
	// )...,
	//)
